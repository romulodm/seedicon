...
Seventeen styles ship in the package — pixel grids, identicons, generative
...
The package root resolves styles by name, so it references all eighteen and
...
```ts
import { truchet, truchetDataUri } from "seedicon/truchet";
...
`seedicon/heraldry` is about 2.3KB gzipped against 18.6KB for the root entry. The
...
One other style (**pixelart**) draws DiceBear's public-domain sprite artwork
(CC0 1.0), driven by seedicon's own PRNG; the **identicon** and **waves**
layouts follow DiceBear's as well. **randomart** is
...
**marble** follows the theme of the same name in Boring Avatars.

The remaining eight — **truchet**, **heraldry**, **kaleidoscope**,
**streamlines**, **moire**, **terrain**, **dither** and **gradient** — are
built here from ideas nobody owns: Truchet tiling, the heraldic vocabulary,
radial symmetry, flow fields, moiré interference, layered ridges and ordered
dithering.

## License

[MIT](https://github.com/romulodm/seedicon/blob/main/LICENSE) © 2026 Romulo de Moraes
